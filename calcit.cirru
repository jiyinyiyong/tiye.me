  ...
  :files $ {}
    'app.browser $ %{} 'FileEntry
      :defs $ {}
        'Element $ %{} 'CodeEntry (:doc |)
          :code $ quote
            deftrait Element (:style 'app.browser/Style)
        ...
        'Navigator $ %{} 'CodeEntry (:doc |)
          :code $ quote
            deftrait Navigator $ :gpu (:: 'JsNullish 'JsObject)
          :examples $ []
          :ffi $ {} (:backend :js) (:kind :external-object)
          :schema $ :: 'Trait
        'Style $ %{} 'CodeEntry (:doc |)
          :code $ quote
            deftrait Style (:scale 'String) (:opacity 'String) (:transform 'String) (:width 'String)
          :examples $ []
          :ffi $ {} (:backend :js) (:kind :external-object)
        ...
        'card-width $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn card-width () $ &min 480
              - (host/viewport-width) 24
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Number)
              :args $ []
        ...
        'gpu-supported? $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn gpu-supported? () $ js-present?
              .-gpu $ unsafe-coerce js/navigator 'app.browser/Navigator
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Bool)
              :args $ []
      ...
      :ns $ %{} 'NsEntry (:doc |)
        :code $ quote
          ns app.browser $ :require (js-ffi.browser :as host)
            reel.schema :refer $ read-field
    'app.comp.container $ %{} 'FileEntry
      :defs $ {}
        'card-width $ %{} 'CodeEntry (:doc |)
          :code $ quote
            def card-width $ browser/card-width
          :examples $ []
          :schema $ :: 'Number
        'comp-avatar $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn comp-avatar (on-home)
              decorate-defcomp
        ...
        'comp-card $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn comp-card (idx key on-open on-close)
              decorate-defcomp
                  ...
                  :tree $ %some
                    let
                      ...
                      div
                        ...
                        div
                          {} $ :style
                            merge styles/row-parted $ {} (:position |absolute) (:top |0px) (:left |0px) (:width |100%) (:padding |4px) (:backdrop-filter "|blur(2px)")
                          span
                        ...
                        if (option:none? info)
                          ...
                          div
                            {} $ :style
                              merge styles/expand $ {} (:padding "|0 12px") (:overflow |auto)
                            =< nil 48
                            , &
                              -> directives $ map
                                fn (directive)
        ...
        'comp-cards $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defcomp comp-cards (router on-open on-close)
              list->
                {} $ :style
                  merge styles/row $ {} (:margin "|auto 0")
                    :width $ str
          ...
          :code $ quote
            defcomp comp-empty (visible? on-home)
              div
                ...
                div
                  {} $ :style
                    merge styles/center $ {} (:color |white) (:font-size |20px) (:line-height |28px) (:text-shadow "|1px 1px 4px black")
                  <> "|题叶"
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'respo.schema/Component)
        ...
        'effect-bump $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn effect-bump () $ effect-on-mount browser/bump!
          :examples $ []
          :schema $ :: 'Fn
        ...
        'effect-fading $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn effect-fading () $ effect-watch ([]) browser/fade-in! (%some browser/fade-out!)
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'respo.schema/Effect)
              :args $ []
        'event-has-close-all? $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn event-has-close-all? (event) (browser/close-all? event)
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Bool)
              :args $ [] (:: 'Map 'Tag 'Dynamic)
        ...
        'gpu-supported? $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defn gpu-supported? () $ browser/gpu-supported?
          :examples $ []
          :schema $ :: 'Fn
            {} (:return 'Bool)
              :args $ []
            ...
            defn render-content (directive on-open)
              match directive
                (:title t)
                  div
                    {} $ :style
                      {} (:font-size |32px) (:margin-top |8px) (:font-weight |300)
                    <> t
                (:text t)
                  div
                    {} $ :style
    ...
    'app.main $ %{} 'FileEntry
      :defs $ {}
        '*reel $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defatom *reel $ typed-reel/new-reel schema/store
          :examples $ []
    ...
    'app.schema $ %{} 'FileEntry
      :defs $ {}
        ...
        'Content $ %{} 'CodeEntry (:doc |)
          :code $ quote
            defenum Content (:title 'String) (:text 'String)
    ...
    'app.style $ %{} 'FileEntry
      :defs $ {}
        'base $ %{} 'CodeEntry (:doc |)
          :code $ quote
            def base $ {} (:line-height |2) (:font-size |14px) (:font-family "|Hind,Verdana,'Hiragino Sans GB','WenQuanYi Micro Hei','Microsoft Yahei',sans-serif") (:color "|hsl(0,0%,20%)")
          :examples $ []
